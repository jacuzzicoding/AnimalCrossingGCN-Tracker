...
class HomeViewModel: ObservableObject {
    ...
    // Placeholder initializer for dependency injection scenarios
    private init() {
        self.dataManager = nil
        self.analyticsService = nil
        self.donationService = nil
        self.isConfigured = false
    }
    
    // Static placeholder instance
    static let placeholder = HomeViewModel()
    
    // Method to configure with dependencies after initialization
    func configure(dataManager: DataManager, analyticsService: AnalyticsServiceProtocol, donationService: DonationServiceProtocol) {
    ...
    // Public method to check if configuration is needed
    var needsConfiguration: Bool {
        return !isConfigured
    }
    
    func loadAllData() {
        guard isConfigured, dataManager != nil else { return }
